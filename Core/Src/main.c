...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
static uint32_t adc_reading = 1234567;

#define ADC_BUFF_LEN 128
static uint32_t adc_buff[ADC_BUFF_LEN] = {0};
static int adc_buff_idx = 0;
/* USER CODE END 0 */
...
int main(void)
{
  ...
  HAL_StatusTypeDef dac_result_start = HAL_DAC_Start(&hdac1, DAC_CHANNEL_1);
 HAL_StatusTypeDef dac_result_setval = HAL_DAC_SetValue(&hdac1, DAC_CHANNEL_1, DAC_ALIGN_12B_R, 0x100);
 ...
 HAL_GPIO_WritePin(EXT_SIG_SELECT_GPIO_Port, EXT_SIG_SELECT_Pin, GPIO_PIN_SET);

 //symulate DAC
// HAL_GPIO_WritePin(WAVE_GEN_GPIO_Port, WAVE_GEN_Pin, GPIO_PIN_RESET);
// HAL_GPIO_TogglePin(WAVE_GEN_GPIO_Port, WAVE_GEN_Pin);
...
//	 adc_buff[adc_buff_idx++] = adc_reading;
//	 if(adc_buff_idx >= ADC_BUFF_LEN) {
//		 adc_buff_idx = 0;
//	 }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EXT_SIG_SELECT_GPIO_Port, EXT_SIG_SELECT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : PGA_N_CS_Pin */
  GPIO_InitStruct.Pin = PGA_N_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(PGA_N_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : DEV_N_CS_Pin */
  GPIO_InitStruct.Pin = DEV_N_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DEV_N_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : EXT_SIG_SELECT_Pin */
  GPIO_InitStruct.Pin = EXT_SIG_SELECT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(EXT_SIG_SELECT_GPIO_Port, &GPIO_InitStruct);
